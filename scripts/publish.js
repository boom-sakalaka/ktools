/*
 * @Date: 2022-04-13 17:55:14
 * @LastEditTime: 2022-04-14 09:34:29
 * @FilePath: \rollup-pro\scripts\publish.js
 * @Description:
 */
...
function publish() {
  console.warn('statr');
  shelljs.sed('-i', '"name": "tools"', '"name": "@boomsakalaka/tools"', targetFile); // 修改包名
  shelljs.sed('-i', `"version": "${currentVersion}"`, `"version": "${newVersion}"`, targetFile); // 修改版本号
  shelljs.sed('-i', `"publish": "node scripts/publish.js"`, `"publish": ""`, targetFile); // 修改版本号
  shelljs.cd('dist');
